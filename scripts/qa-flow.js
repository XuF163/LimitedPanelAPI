...
import { cmdMetaSync } from "../src/meta/sync.js"
import { cmdSampleCollect } from "../src/samples/collect.js"
import { cmdPresetGenerate } from "../src/preset/generate.js"
import { ensureProxyPool } from "../src/proxy/pool.js"
import { projectRoot } from "../src/config.js"
import { loadGsMeta } from "../src/meta/gs.js"
import { loadSrMeta } from "../src/meta/sr.js"
import { calcGsBuildMark } from "../src/score/gs.js"
import { calcSrBuildMark } from "../src/score/sr.js"
import { calcZzzAvatarMark } from "../src/score/zzz.js"
import { findZzzSignatureWeaponId } from "../src/zzz/weapon.js"
...
async function main() {
  ...
  const concurrency = Math.max(1, Math.min(50, toInt(process.env.CONCURRENCY || process.env.ENKA_CONCURRENCY, Number(qaScan?.concurrency ?? cfg?.samples?.enka?.concurrency ?? proxyPoolSize))))
  ...
  const results = { startedAt: nowMs(), proxy: { count: proxyUrls.length }, games: {} }
  ...
  try {
    ...
    if (games.includes("zzz")) {
      ...
      const verify = await verifyZzzPreset({
        uid: uidZzz,
        minMark: zzzMinMark,
  ...
  results.pass = Object.values(results.games).every((g) => g?.pass === true)
